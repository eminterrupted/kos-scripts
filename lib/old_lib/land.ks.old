...
// #region
    ...
    // Time to impact
    global function time_to_landing_burn
    {
        parameter _availDV to 0.
                  
        if Ship:Periapsis < 0
        {
            local currentVelocity to Min(0, VerticalSpeed).
            local distance to Ship:Altitude - Ship:GeoPosition:TerrainHeight.
    ...
    {
        parameter currentVelocity is VerticalSpeed,
                  distance is Ship:Altitude - Ship:Geoposition:TerrianHeight.
    ...
    global function land_optimize_landing_node_data
    {
        ...
        until iteration >= 5
        {
            ...
            {
                OutInfo("Same score iteration: " + iteration, 2).
                set iteration to iteration + 1.
            }
            wait 0.01.
        }
        print "                        " at (2, 25).
        OutInfo("Optimized maneuver found (score: " + round(nodeScore, 5) + ")").
        ClearDispBlock(). 
        return data.
    }
