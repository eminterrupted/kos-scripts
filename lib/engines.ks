...
// #region
    ...
    set g_PartRef["Engines"] to lexicon( 
        "SepRef", list(
...
// #region
    ...
    global function GetEnginesForStage
    {
        ...
        for eng in ship:engines
        {
            ...
            { 
                ...
                {
                    if not g_PartRef:Engines:SepRef:Contains(eng:Name) and eng:Tag:Length = 0
                    {
                        engList:Add(eng).
                    }
                }
                ...
                {
                    if g_PartRef:Engines:SepRef:Contains(eng:Name)
                    {
                        engList:Add(eng).
                    }
                }
    ...
    global function GetEngineSpecs
    {
        ...
        local sepMotorCheck to (g_PartRef:Engines:SepRef:Contains(_eng:Name) and _eng:Tag:Length = 0).
    ...
    global function GetEnginesPerformanceData
    {
        ...
        from { local i to 0.} until i = _engList:Length step { set i to i + 1.} do
        {
            ...
            // {
                ...
                {
                    if g_PartRef["Engines"]:SEPREF:Contains(eng:Name) set aggEngPerfObj["SepStg"] to true.
