...
//#include "0:/lib/lib_disp"
//#include "0:/lib/lib_land"
//#include "0:/lib/lib_mnv"
...
local adjBurnDurFactor to 0.05.
local burnDur       to 0.
...
// If no active engines, stage
if ship:availableThrust <= 0.1 
{
    until ship:availableThrust > 0.1 ves_safe_stage().
}
