...
until g_Program < 0
{
    ...
    else if g_Program = 923
    {
        ...
        else if g_RunMode = 2
        {
            ...
            {
                cr().
                OutInfo("DISTANCE TO GROUND: {0}":Format(Round(Alt:radar, 1))).
            }
        }
        else if g_Runmode < 0
        {
    ...
    else if g_Program = 925
    {
        ...
        {
            cr().
            OutInfo("* RECOVERY IN {0}s *":Format(Round(settleTS - Time:Seconds, 2))).
